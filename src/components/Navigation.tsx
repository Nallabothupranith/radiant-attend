...
const Navigation = () => {
  ...
  const navigation = [
    ...
    { name: "Risk Analysis", href: "/student/risk-prediction", icon: AlertTriangle },
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80">
              ...
              <DropdownMenuItem className="text-center" asChild>
                <Link to="/student/notifications" className="text-sm text-muted-foreground">View all notifications</Link>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        </div>
