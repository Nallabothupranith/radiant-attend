  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/" element={<PageTransition><StudentDashboard /></PageTransition>} />
        <Route path="/profile" element={<PageTransition><Profile /></PageTransition>} />
        <Route path="/risk-prediction" element={<PageTransition><RiskPrediction /></PageTransition>} />
        <Route path="/counseling" element={<PageTransition><CounselingRequest /></PageTransition>} />
        ...
        <Route path="/fees" element={<PageTransition><FeesStructure /></PageTransition>} />
